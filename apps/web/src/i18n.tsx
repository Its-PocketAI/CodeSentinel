...
const EN: Record<string, string> = {
  ...
  "删除会话失败": "Delete session failed",
  "终端会话打开失败": "Open terminal session failed",
  ...
  "[提示] 已进入复制模式，拖动手指选择文本后点击复制": "[Hint] Copy mode enabled. Drag to select text, then tap Copy",
  "[提示] 未选中文本，请先拖动选择": "[Hint] No text selected. Drag to select text first",
  "[提示] 无法读取系统剪贴板，请使用“粘贴命令”": "[Hint] Cannot read system clipboard. Use “Paste command” instead",
  "[成功] 已准备图片提问 {name}": "[Success] Ask Image ready: {name}",
  "[成功] 已复制终端选中内容": "[Success] Copied selected terminal text",
  "[成功] 已从剪贴板粘贴到终端": "[Success] Pasted clipboard text to terminal",
  "[成功] 已保存 {name}": "[Success] Saved {name}",
  "[错误] 复制失败，请重试": "[Error] Copy failed. Please try again",
