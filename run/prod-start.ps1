...
& pnpm build 2>&1 | Tee-Object -FilePath $LogFile -Append | Out-Null
...
$proc = Start-Process -FilePath "pnpm" -ArgumentList "start" -WorkingDirectory $RootDir -NoNewWindow -PassThru -RedirectStandardOutput $LogFile -RedirectStandardError $LogFile
